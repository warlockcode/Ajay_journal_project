...
public class LikedorNotJournal {
    public boolean result= true;
    public LikedorNotJournal(){};
    JournalRecyclerAdapter.ViewHolder holder;
    ...
    public LikedorNotJournal(Journal journal, JournalRecyclerAdapter.ViewHolder holder)
    {
